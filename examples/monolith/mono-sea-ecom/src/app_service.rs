...
impl AppService {
    ...
    pub fn health(&self) -> HealthInfo {
        HealthInfo {
            ...
            app: self.config.get_or("APP_NAME", "mono-sea-ecom"),
    ...
    pub fn info(&self) -> AppInfo {
        AppInfo {
            name: self.config.get_or("APP_NAME", "mono-sea-ecom"),
            description: "Monolith e-commerce API built with Ferrite + sea-orm — supports SQLite / Postgres / MySQL.",
            ...
            orm: "sea-orm (ferrite-orm-sea features = [sqlite, postgres, mysql])",
        }
    }
}
