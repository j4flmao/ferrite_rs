...
impl AppService {
    ...
    pub fn health(&self) -> HealthInfo {
        HealthInfo {
            ...
            app: self.config.get_or("APP_NAME", "mono-diesel-ecom"),
    ...
    pub fn info(&self) -> AppInfo {
        AppInfo {
            name: self.config.get_or("APP_NAME", "mono-diesel-ecom"),
            description: "Monolith e-commerce API built with Ferrite + diesel — supports SQLite / Postgres / MySQL.",
            ...
            orm: "diesel (ferrite-orm-diesel features = [sqlite, postgres, mysql])",
        }
    }
}
