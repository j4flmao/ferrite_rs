...
async fn main() {
    ...
    grpc.add_service(crate::products::ProductsGrpcService::new());
    ...
    tokio::spawn(async move {
        ...
        eprintln!(
            "[ferrite-grpc] products.grpc = {:?} (inventory={grpc_names:?}, manual_added={manual_services}) listening on {grpc_addr}",
            crate::products::PRODUCTS_GRPC_SERVICE_NAME
        );
